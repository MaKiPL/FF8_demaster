...
//const DWORD TEXPATCH1_d = 0x16054FE; //first: 0x15A992F;
//const DWORD TEXPATCH2_d = 0x1606A1C; //first: 0x15AA3E6;		//0x15AA3EB; [as above]
//const DWORD TEXPATCH3_d = 0x1603900; //first: 0x15A9842;
//const DWORD TEXPATCH4_d = 0x1601E4B; //first: 0x15AC4A4;
//
//
//
//DWORD* _thisFF8_d = 0; //__thiscall, so this is ECX
...
//		}
//	}
//	currentLanguage = *(_thisFF8_d + 0x3F);
//
...
//				TexFuncBattleSegment(_thisFF8_d, tex_struct[51], tex_struct[52]);
//			}
//			else if (tex_struct[48] == 57) //FIELD
//			{
//				v38 = tex_struct[50] + 4 * tex_struct[50] + 213;
//				v40 = (BYTE*)_thisFF8_d + 8 * v38; //
//				v39 = *(DWORD*)v40;
//
...
//					{
//						TexFuncCharaSegment(_thisFF8_d, 1, tex_struct[51], tex_struct[52] - 1);
//						glGenTextures(1, &OPENGL_TEXTURES);
//						glBindTexture(GL_TEXTURE_2D, OPENGL_TEXTURES);
...
//							glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP);
//							glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP);
//							TexFuncCharaSegment(_thisFF8_d, 0, tex_struct[57], tex_struct[58] - 1);
//							glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, lastHeight * 2, lastHeight * 2, 0, GL_RGBA, GL_UNSIGNED_BYTE, 0); //sets the atlas
...
//		TexFuncBattleMonsterSegment(_thisFF8_d, v4);
//	}
//
//	//============================                   [BEGIN]                           ==============================\\\\\\
...
//void ReplaceTextureFunction_deprecated()
//{
//	int textureFunction = IMAGE_BASE + TEXPATCH1_d;	//0x15A9920; [comment for no SEH/rewind]
//	tex_returnAddress = IMAGE_BASE + TEXPATCH2_d;		//0x15AA3EB; [as above]
...
//	int patchDinputXinput = IMAGE_BASE + TEXPATCH3_d;
//	modPage(patchDinputXinput, 1);
//	*(BYTE*)(patchDinputXinput) = 0xEB; //JMP relative 8bit
//
//
//	int patchUnwantedTexStructFree = IMAGE_BASE + TEXPATCH4_d;
