...
#define ADR__ASM_FIELDBGRETADDR2 0x1606A20
#define ADR__ASM_FIELDBGRETADDR3 0x1591EA5
#define ADR__BHPBACKADD1 0x157DFBD
#define ADR__BHPBACKADD2 0x157E265
#define ADR__BSPBACKADD1 0x1573F4F
#define ADR__BSPBACKADD2 0x1573FA4
#define ADR_BATTLEJMPPATCH1 0x156D324
#define ADR_BATTLEJMPPATCH2 0x156D75B
#define ADR_BCPBACKADD1 0x1606B9D
#define ADR_BCPBACKADD2 0x1604567
#define ADR_BCPBACKADD3 0x1605520
#define ADR_BGFILENAME1 0x1782160
#define ADR_BGFILENAME2 0x18955BC
#define ADR_BGRESPATCH1 0x156E2C7
#define ADR_BHP 0x1648938
#define ADR_BTLMON0 0x15FF6F0
#define ADR_BTLMON1 0x15FF6FA
#define ADR_BTLMON2 0x15FF719
#define ADR_BTLMON3 0x15FF720
#define ADR_BTLMON4 0x16022E2
#define ADR_BTLMON5 0x16022E6
#define ADR_BTLMON6 0x16021DE
#define ADR_CHECKTEXREPAVAIL 0x17820A0
#define ADR_CLTBACKADD1 0x155D1A5
#define ADR_CLTBACKADD2 0x155D21A
#define ADR_DISABLETPAGELIMIT 0x1606A75
#define ADR_DS_FREE 0x166B2A8
#define ADR_DS_TEXIMG 0x166B4AC
#define ADR_FCPBACKADD1 0x16066AC
#define ADR_FCP_PRETEXSUBIMAGE 0x160C940
#define ADR_FIELDCHARENT1 0x160C8DC
#define ADR_FIELDCHARENT2 0x160C907
#define ADR_FILTERPATCH1 0x156985F
#define ADR_FILTERPATCH2 0x1569879
#define ADR_FILTERPATCH3 0x156A7B8
#define ADR_FILTERPATCH4 0x156A7C9
#define ADR_IOFUNC1 0x364CC
#define ADR_IOFUNC2 0x36B37
#define ADR_IOFUNC3 0x36b78
#define ADR_IOFUNC4 0x36d37
#define ADR_IOFUNC5 0x365F8
#define ADR_IOFUNC6 0x3656A
#define ADR_NEWGLTEX_CHARA 0x160BB50
#define ADR_NULLSUB_DEBUG 0x33DC0
#define ADR_UPLOADVRAM 0x1573E90
#define ADR_UVFUNCPNTR 0x9113B5
#define ADR_UVPATCH0 0x9113B5
#define ADR_UVPATCH1 0x9113bb
#define ADR_UVPATCH10 0x911576
#define ADR_UVPATCH11 0x91157C
#define ADR_UVPATCH2 0x911417
#define ADR_UVPATCH3 0x91141d
#define ADR_UVPATCH4 0x911474
#define ADR_UVPATCH5 0x91147A
#define ADR_UVPATCH6 0x9114D3
#define ADR_UVPATCH7 0x9114D9
#define ADR_UVPATCH8 0x911530
#define ADR_UVPATCH9 0x911536
#define ADR_WINDOWTITLE 0x1601535
#define ADR_WORLDGETTEXIDX0 0x17424B0
#define ADR_WORLDGETTEXIDX1 0x17424B4
#define ADR_WORLDGETTEXIDX2 0x17424B8
#define ADR_WORLDGETTEXIDX3 0x17424Bc
#define ADR_CHANGEMODE 0x1600EB0
#define ADR_STEAMADDR 0x16EED10
#define ADR_MAGICIDLOAD 0x7FDF20
#else
#define ADR__ASM_FIELDBGRETADDR2 0x16382A2
#define ADR__ASM_FIELDBGRETADDR3 0x15C37E5
#define ADR__BHPBACKADD1 0x15B495D
#define ADR__BHPBACKADD2 0x15B4C05
#define ADR__BSPBACKADD1 0x15AA9EF
#define ADR__BSPBACKADD2 0x15AAA44
#define ADR_BATTLEJMPPATCH1 0x15A3DB4
#define ADR_BATTLEJMPPATCH2 0x15A41EB
#define ADR_BCPBACKADD1 0x163841F
#define ADR_BCPBACKADD2 0x1635E77
#define ADR_BCPBACKADD3 0x1636E30
#define ADR_BGFILENAME1 0x1793CB4
#define ADR_BGFILENAME2 0x18A8418
#define ADR_BGRESPATCH1 0x15A4D57
#define ADR_BHP 0x1679F98
#define ADR_BTLMON0 0x1631230
#define ADR_BTLMON1 0x163123A
#define ADR_BTLMON2 0x1631259
#define ADR_BTLMON3 0x1631260
#define ADR_BTLMON4 0x1633BF2
#define ADR_BTLMON5 0x1633BF6
#define ADR_BTLMON6 0x1633AEE
#define ADR_CHANGEMODE 0x16327C0
#define ADR_CHECKTEXREPAVAIL 0x1793BB0
#define ADR_CLTBACKADD1 0x15938D5
#define ADR_CLTBACKADD2 0x159394A
#define ADR_DISABLETPAGELIMIT 0x16382F7
#define ADR_DS_FREE 0x169D2A8
#define ADR_DS_TEXIMG 0x169D4AC
#define ADR_FCP_PRETEXSUBIMAGE 0x163E330
#define ADR_FCPBACKADD1 0x1637F2E
#define ADR_FIELDCHARENT1 0x163E2CC
#define ADR_FIELDCHARENT2 0x163E2F7
#define ADR_FILTERPATCH1 0x159FE5F
#define ADR_FILTERPATCH2 0x159FE79
#define ADR_FILTERPATCH3 0x15A0D86
#define ADR_FILTERPATCH4 0x15A0D97
#define ADR_IOFUNC1 0x3649C
#define ADR_IOFUNC2 0x36B07
#define ADR_IOFUNC3 0x36B48
#define ADR_IOFUNC4 0x36D07
#define ADR_IOFUNC5 0x365C8
#define ADR_IOFUNC6 0x3653A
#define ADR_MAGICIDLOAD 0x838480
#define ADR_NEWGLTEX_CHARA 0x163D500
#define ADR_NULLSUB_DEBUG 0x33E50
#define ADR_STEAMADDR 0x16FED48
#define ADR_UPLOADVRAM 0x15AA930
#define ADR_UVFUNCPNTR 0x94A8FC
#define ADR_UVPATCH0 0x94A8FC
#define ADR_UVPATCH1 0x94A902
#define ADR_UVPATCH10 0x94AAC1
#define ADR_UVPATCH11 0x94AAC7
#define ADR_UVPATCH2 0x94A95E
#define ADR_UVPATCH3 0x94A964
#define ADR_UVPATCH4 0x94A9BD
#define ADR_UVPATCH5 0x94A9C3
#define ADR_UVPATCH6 0x94AA1C
#define ADR_UVPATCH7 0x94AA22
#define ADR_UVPATCH8 0x94AA7B
#define ADR_UVPATCH9 0x94AA81
#define ADR_WINDOWTITLE 0x1632E45
#define ADR_WORLDGETTEXIDX0 0x1753F70
#define ADR_WORLDGETTEXIDX1 0x1753F74
#define ADR_WORLDGETTEXIDX2 0x1753F78
#define ADR_WORLDGETTEXIDX3 0x1753F7C
#endif // !JAPANESE_PATCH
